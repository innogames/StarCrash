...
var items = [[	1,	'Pipe',			'pipe',			2,				10,			"A",	"equipable",	0 ],
			 ...
			 [	24,	'Bottle',		'bottle',		2,				5,			"C",	"equipable",	0 ],
			 [	25,	'Alcohol',		'alc',			1,				5,			"C",	"consumable",  15 ],
			 [	27,	'Sling',		'sling',		3,				9,			"A",	"equipable",	0 ],
			 [	28,	'Bandage',		'bandages',		1,				2,			"C",	"consumable",  25 ],
			 [	29,	'Duct Tape',	'tape',			1,				3,			"B",	"equipable",	0 ],
			 [	31,	'Wrench',		'wrench',		3,			   11,			"A",	"equipable",	0 ],
			 [	38,	'Rope',			'rope',			2,			    8,			"A",	"equipable",	0 ],
			 [	40,	'Helmet',		'helmet',		5,			    9,			"D",	"armor",	   30 ],
			 [	41,	'Boots',		'boots',		4,			   11,			"D",	"armor",		0 ]
			];
